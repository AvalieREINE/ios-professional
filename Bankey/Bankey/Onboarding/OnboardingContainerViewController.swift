...
//  Bankey
//
//  Created by Soeur Zhang on 9/04/22.
//
...
class OnboardingContainerViewController: UIViewController {
    ...
    override init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: Bundle?) {
        ...
        let page1 = OnboardingViewController(heroImageName: "delorean", titleText: "Bankey is faster and easier to use, and has a brand new look")
        let page2 = OnboardingViewController(heroImageName: "world", titleText: "Bankey is faster and easier to use, and has a brand new look")
        let page3 = OnboardingViewController(heroImageName: "thumbs", titleText: "Bankey is faster and easier to use, and has a brand new look")
